...
Esse projeto foi realizado durante o curso de Desenvolvimento Web da Trybe. Foram os primeiros passos dados no aprendizado em React, onde precisamos criar classes para gerar cards de informações sobre os planetas e as missões espaciais.
